<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Logout.aspx.cs" Inherits="FBTS.View.Logout" %>
                ...
                <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                    <section class="panel bg-white no-b">
                        <div class="panel-heading ">
                            <div class="row">
                                <div class="col-md-8">
                                    <h4><strong>You have been logged out successfully.</strong></h4>
                                    <%--<h5>Click <asp:HyperLink ID="linkLogin" runat="server"><i><u>here</u></i></asp:HyperLink> to login again.</h5>--%>
                                </div>
                                <div class="col-md-4">
