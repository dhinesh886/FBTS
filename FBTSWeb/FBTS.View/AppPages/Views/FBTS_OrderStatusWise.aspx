<%@ Page Title="" Language="C#" MasterPageFile="~/AppPages/Common/Site.Master" AutoEventWireup="true" CodeBehind="FBTS_OrderStatusWise.aspx.cs" Inherits="FBTS.View.AppPages.Views.FBTS_OrderStatusWise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      <script type="text/javascript">
          ...
          function ddlValidate() {
              if (!validateMandatoryField($('#<%=ddlOrderType.ClientID%>'), "Please Select Order Status!!")) return false;
              return true;
          }
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <asp:DropDownList ID="ddlOrderType" runat="server" CssClass="form-control chosen" AutoPostBack="true">
                                                    ...
                                                    <asp:ListItem Value="AN">Alternate Part Number Needed</asp:ListItem>
                            ...
                            <ContentTemplate>                                             
                                <div class="row p10">
                                   <div class="col-md-12" style="padding-top:5px;">
                                       <rsweb:ReportViewer ID="StatusWiseOrderViewer" runat="server" Width="100%"></rsweb:ReportViewer>
                                   </div>
                                </div>                                                 
                            </ContentTemplate>
                        </asp:UpdatePanel>
