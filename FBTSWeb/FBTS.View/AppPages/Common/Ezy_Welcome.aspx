<%@ Page Title="" Language="C#" MasterPageFile="~/AppPages/Common/Site.Master" AutoEventWireup="true" CodeBehind="Ezy_Welcome.aspx.cs" Inherits="FBTS.View.Ezy_Welcome" %>
 
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%--<link href="../Resources/UI/plugins/jvectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" />--%>
                <%--<div class="row">
         ...
         <%--   <script src="../Resources/UI/js/dashboard.js"></script>
        <script src="../Resources/UI/plugins/jquery.blockUI.js"></script>
        <script src="../Resources/UI/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="../Resources/UI/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
        <script src="../Resources/UI/plugins/jquery.sparkline.js"></script>
        <script src="../Resources/UI/plugins/flot/jquery.flot.js"></script>
        <script src="../Resources/UI/plugins/flot/jquery.flot.resize.js"></script>
        <script src="../Resources/UI/plugins/count-to/jquery.countTo.js"></script>--%>
</asp:Content>