<%@ Page Title="" Language="C#" MasterPageFile="~/AppPages/Common/Site.Master" AutoEventWireup="true" CodeBehind="FBTS_UserProfile_SSO.aspx.cs" Inherits="FBTS.View.AppPages.CPanel.FBTS_UserProfileSSO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script>
        ...
        function jsValidateForm() {
            if (!validateMandatoryField($('#<%=txtUserId.ClientID %>'), "SSO ID Cannot be Blank!!")) return false;            
                                        ...
                                        <ContentTemplate>
                                            <div class="no-more-tables">
                                                <asp:GridView ID="GridViewTable" runat="server" CssClass="table table-striped table-bordered table-hover"
                                                    FooterStyle="table table-bordered table-striped table-condensed" Width="100%" AutoGenerateColumns="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="LoginId" HeaderText="SSO Id"></asp:BoundField>
                                        ...
                                        <div class="row">                                            
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>SSO ID<span class="text-danger">*</span></label>
                                                    <div>
                                                        ...
                                                        <asp:TextBox ID="txtUserId" runat="server" class="form-control" onkeypress="return validentry('N',event);" placeholder="User Id" MaxLength="9"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="row" style="padding-bottom: 15px;">
                                            <div class="col-md-8  ">
                                                <b>User Name :</b> <b>
                                                    <asp:Label ID="lblAccessLevel" runat="server" Text="Label"></asp:Label></b>
